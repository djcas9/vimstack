...
hi Folded guifg=#a0a8b0 guibg=#384048 ctermfg=245 ctermbg=235
hi Title guifg=#f6f3e8 gui=bold ctermfg=187 cterm=bold
hi Visual guibg=#262D51 ctermbg=234 ctermfg=245
...
" hi LongLineWarning gui=undercurl ctermfg=203 ctermbg=3 cterm=underline guisp=#FF6C60
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi Search guifg=#000000 guibg=#cae682 ctermfg= ctermbg=51

  " hi ColorColumn guifg=#000000 guibg=#cae682 ctermfg=255 ctermbg=233
